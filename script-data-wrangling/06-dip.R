...
# Table 4.5:  Graduatoria dei Dipartimenti piccoli 
dip_p <- readxl::read_xlsx(nome_file,
                           sheet = "Tabella 4.5",
                           skip = 6)
# Table 4.9:  Graduatoria dei Dipartimenti medi 
dip_m <- readxl::read_xlsx(nome_file,
                           sheet = "Tabella 4.9",
                           skip = 6)
# Table 4.13:  Graduatoria dei Dipartimenti grandi 
...
id_nome <- which(!(names(dip_p) %in% names(dip_g)))
names(dip_p)[id_nome] <- names(dip_g)[id_nome]
