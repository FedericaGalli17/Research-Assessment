...
# Table 2.16: Punteggi ottenuti e distribuzione dei prodotti nelle classi di merito 
ssd <- readxl::read_xls("dati-vqr-11-14/VQR2011-2014_Area04_Tabelle.xls",
                        sheet = "Tabella 2.16", 
                        skip = 1)
